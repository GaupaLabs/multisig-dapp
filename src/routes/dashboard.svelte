<script>
    ...
    function proposeSending() {
        ...
        let request = 'https://devnet-wallet.elrond.com/hook/transaction?receiver=' + $contractAddress + '&value=0&data=proposeTransferExecute@' + parsedAddress + '@' + parsedEGLDAmount.toString(16) + '&callbackUrl=http://localhost:3000/dashboard';
...
<div class="container hero-dark text-light">
	<div class="row justify-content-center align-items-center">
		...
		<div class="col-lg-6 text-dark">
			<p class="address-card">{userAddress}</p>
		</div>
	</div>
</div>
	...
	<div class="row">
		<div class="col">
			...
			<ul class="nav nav-tabs" style="margin-top: 2em;">
				...
				<div class="nav-item" on:click={(e) => (selectedTab = 'funds')}>
					<p class="nav-link" class:active={selectedTab === 'funds'}>Funds Distribution</p>
				</div>
			</ul>
			{#if selectedTab === 'send'}
				<div class="row form-wrapper align-items-end">
					<div class="col">
						<p>Enter address and amount to be sent.</p>
                        <label for="receiver-address">Receiver Address</label>
						<input type="text" class="form-control" id="receiver-address" placeholder="Address" aria-label="Address" bind:value={receiverAddress}/>
					</div>
					<div class="col">
                        <label for="amount">Amount</label>
						<div class="input-group">
							<input type="number" class="form-control" id="amount" placeholder="Amount" aria-label="Amount" bind:value={amountEGLD}/>
...
<div class="container hero text-dark" style="margin-top: -4em;">
    <div class="row">
        <div class="col">
            ...
            <p><a href="https://devnet-explorer.elrond.com/transactions/{lastTx}" target="_blank">View in explorer</a></p>
        </div>
    </div>
</div>
